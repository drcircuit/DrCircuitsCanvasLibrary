...
export { BLACK, BLUE, CYAN, E, GRAY, GREEN, KEYB, KEYS, MAGENTA, MOUSE, PI, RED, TAU, TRANS, WHITE, YELLOW, abs, animate, atan, atan2, ceil, circle, clamp, color, complex, cos, createBuffer, createSprite, curve, dcl as default, exp, fill, floor, fract, getCtx, lerp, line, log, matrix, max, min, mod, palette, playAnimation, pow, rad, random, randomi, rect, round, setupRun, setupScreen, shapes, sin, sprite, sqrt, startAnimation, stopAnimation, stroke, tan, text, trig$1 as trig, vector };
//# sourceMappingURL=dcl.module.js.map
